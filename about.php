...
<html lang="en">
  ...
  <body class="goto-here">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="about.php" class="nav-link">Who are we</a></li>
    ...
    <section class="ftco-section">
      <div class="container">
        <center><h2 class="mb-4" style="font-weight: bold;">MS Tyaari Founders</h2></center>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="product">
              <center><a class="img-prod"><img class="img-fluid" src="images/admin2.jpg" style="max-width: 170px;border-radius: 50%;"></center></a>
              <div class="text py-3 pb-4 px-3 text-center">
                <h3>
                  <a>
                    <?php 
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="product">
              <center><a class="img-prod"><img class="img-fluid" src="images/admin3.jpg" style="max-width: 170px;border-radius: 50%;"></center></a>
              <div class="text py-3 pb-4 px-3 text-center">
                <h3><a>
                <?php 
                      echo $lines[8];?><br/>
